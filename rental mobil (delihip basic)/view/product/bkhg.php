...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Bolu Ketam Hitam Polos.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Bolu Pisang Polos</h5>
        <p class="card-text">komposisi dari bolu ketan hitam gondrong sebagai berikut : tepung ketan hitam, terigu, gula, telur, vanila bubuk, susu kental manis, minyak kelapa, butter cream dan keju 
        </p>
        <p class="card-text">Rp 60.000 <a class="btn btn-primary btn-sm" href="../profil/transaksi.php" role="btn" >Add to cart</a>
        </p>
      </div>
    </div>
  </div>
