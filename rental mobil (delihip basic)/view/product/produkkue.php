...
$sql="select * from kue where kode_kue='$kue'";
$res=$db->query($sql);
if($res){
...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="<?php echo $imgurl?>" class="img-fluid rounded-start" alt="..." style="max-width: 20rem;
                            max-height: 20rem;
                            float: left;
                            width: 235px;
                            height: 235px;
    ...
    <div class="col-md-8">
      <div class="card-body">
      <form name="inputkue" action="../profil/transaksi.php" method="post">
        <h5 class="card-title" name="namakue"><?php echo $namakue ?></h5>
        <p class="card-text" name="harga">Rp.<?php echo $harga ?> <input type="submit" name="input" value="add to cart" class="btn btn-primary" role="button">
        <input type="hidden" name="kodekue" value="<?php echo $kodekue ?>">
        <input type="hidden" name="namakue" value="<?php echo $namakue ?>">
