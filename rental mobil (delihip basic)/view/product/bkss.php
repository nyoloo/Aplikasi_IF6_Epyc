...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Bolu Karamel Sarang Semut.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Bolu Ketam Sarang Semut</h5>
        <p class="card-text">komposisi dari bolu karamel semut sebagai berikut :  gula, air, telur, tepung terigu, tepung tapioka,soda kue, margarin, susu kental manis
        </p>
        <p class="card-text">Rp 40.000 <a class="btn btn-primary btn-sm" href="../profil/transaksi.php" role="btn" >Add to cart</a>
        </p>
      </div>
    </div>
  </div>
