...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Red Velvet Keju Gondrong (3).jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Red Valve</h5>
        <p class="card-text">komposisi dari red valve sebagai berikut : tepung terigu, gula, margarin, susu kental manis, buttercream, keju, pewarna makanan berwarna merah
        </p>
