...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Brownies Keju Gondrong.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Brownies Keju</h5>
        <p class="card-text">komposisi dari Brownies Keju sebagai berikut : gula, air, margarin, dark coco, tepung, telur, baking powder
        </p>
