...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Marble Coklat.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Marble Coklat</h5>
        <p class="card-text">komposisi dari marble coklat sebagai berikut : tepung terigu, gula, margarin, susu kental manis, coklat bubuk
        </p>
