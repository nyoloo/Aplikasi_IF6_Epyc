...
<div class="card" style="max-width: 700px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../kue/Marbel Ceres.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Marble Ceres</h5>
        <p class="card-text">komposisi dari marble ceres sebagai berikut : tepung terigu, gula, margarin, susu kental manis, buttercream, cerea
        </p>
        <p class="card-text">Rp 65.000 <a class="btn btn-primary btn-sm" href="../profil/transaksi.php" role="btn" >Add to cart</a>
        </p>
      </div>
    </div>
  </div>
